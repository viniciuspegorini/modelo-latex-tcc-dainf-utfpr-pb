...
\section{Observações Sobre a Formatação do Texto}\label{sec:formatacaoTexto}
...
Exemplo de citação direta curta com autor incluso no texto: Segundo \citeonline{Pressman2009} o valor da informação está “diretamente ligado à maneira como ela ajuda os tomadores de decisões a atingirem as metas da organização”. Exemplo de citação direta curta com autor não incluso no texto: O autor lembra, contudo, a análise precursora de \citeonline{Pressman2009} sobre alguns aspectos limitantes das competências, ou aptidões, essenciais, que as transformam em “limitações estratégicas” \cite{Pressman2009}.

As transcrições com mais de três linhas (citações diretas longas) aparecem recuadas em 4 cm, a partir da margem esquerda, em espaço simples, tamanho 11, e a indicação da fonte é apresentada entre parênteses. 
...
\begin{figure}[htb]%% Ambiente figure
    ...
    \includegraphics[scale=0.4]{./Capitulo2/arquivos/cs2}%% Dimensões e localização
...
\begin{figure}[htb]
	...
	\subfloat[Cadastro Paciente]{
		\includegraphics[scale=0.7]{./Capitulo2/arquivos/cadastro-paciente}
	}\hspace{0.15cm} 
